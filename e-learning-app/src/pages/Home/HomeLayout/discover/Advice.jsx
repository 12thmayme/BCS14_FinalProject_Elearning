          ...
          >
            <div className=" col-span-1  mt-10 p-5 text-sm md:text-base lg:text-lg text-gray-700 font-thin xl:text-2xl xl:ml-48">
              <p className="mb-5">
                ...
                level. Our product offers a vast library of courses across
                diverse fields, enabling you to learn at your own pace and
                convenience. Benefit from interactive workshops, expert-led
                seminars, and industry-recognized certifications.
              </p>
              <p className="mb-10">
                ...
                essential skills like communication and problem-solving. With
                our e-learning product, you can ensure your continuous growth
                and success in an ever-evolving job market.
              </p>
              <NavLink
                to="/course"
                className="bg-primary rounded-3xl px-5 py-3 font-semibold text-black"
              >
                Discovery more
              </NavLink>
            </div>
