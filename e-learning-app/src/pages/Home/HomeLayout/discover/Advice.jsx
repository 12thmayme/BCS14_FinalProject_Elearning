  ...
  return (
    <section className="container">
      <div className="lg:flex lg:justify-end lg:items-center">
        <h3 className="p-5 mb-14 text-2xl font-normal text-black xl:mb-0 max-w-[700px] xl:text-5xl">
          Propel your <span className="text-primary">career & expand</span> your
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mb-20">
        ...
        <div className=" col-span-1  mt-10 p-5 text-sm md:text-base lg:text-lg text-gray-700 font-thin xl:text-2xl xl:ml-48">
          ...
          <p className="mb-10">
            Connect with mentors and peers through our networking features, and
            set clear career goals with our personalized learning paths. Stay
            ahead of the curve by embracing new technologies and honing
